  ...
  [5669],
  {
    11954: (e, t, s) => {
      ...
      let r = Symbol(),
        ...
        l = (e) =>
          (((e) =>
            ...
            (a.has(e)
              ? a.get(e)
              : o(e) === Object.prototype || o(e) === Array.prototype))(e) &&
            e[r]) ||
          null,
        n = (e, t = !0) => {
          a.set(e, t);
        ...
        [p] = ((
          ...
          u = [1, 1],
          f = (r) => {
            if (!i(r)) throw Error("object required");
            let o = p.get(r);
            if (o) return o;
            let n = u[0],
              h = new Set(),
              g = (e, t = ++u[0]) => {
                n !== t && ((n = t), h.forEach((s) => s(e, t)));
              },
              m = u[1],
              b = (e = ++u[1]) => (
                m === e ||
              ...
              O = {
                ...
                set(t, r, o, a) {
                  let n = Reflect.has(t, r),
                    u = Reflect.get(t, r, a);
                  if (n && (e(u, o) || (p.has(o) && e(u, p.get(o))))) return !0;
                  I(r), i(o) && (o = l(o) || o);
                  let h = o;
        ...
        b = {
          ...
          formatUniversalUrl(e, t, s) {
            ...
            if (r.startsWith("https://t.me")) {
              let e = h.from(t).toString("base64").replace(/[=]/g, "");
          ...
          setModalVersionInStorage() {
            try {
              "undefined" != typeof localStorage &&
                localStorage.setItem(b.WCM_VERSION, "2.7.0");
            } catch (e) {
      ...
      var O = Object.defineProperty,
        ...
        A = (e, t, s) =>
          t in e
            ...
            : (e[t] = s);
      let k = "https://explorer-api.walletconnect.com",
        M = "js-2.7.0";
      async function D(e, t) {
        let s = ((e, t) => {
            for (var s in t || (t = {})) L.call(t, s) && A(e, s, t[s]);
            if (E) for (var s of E(t)) j.call(t, s) && A(e, s, t[s]);
            return e;
          })({ sdkType: "wcm", sdkVersion: M }, t),
          r = new URL(e, k);
        return (
      ...
      let U = {
        ...
        getWalletImageUrl: (e) =>
          `${k}/w3m/v1/getWalletImage/${e}?projectId=${W.state.projectId}&sdkType=wcm&sdkVersion=${M}`,
        getAssetImageUrl: (e) =>
          `${k}/w3m/v1/getAssetImage/${e}?projectId=${W.state.projectId}&sdkType=wcm&sdkVersion=${M}`,
      };
      ...
      let R = b.isMobile(),
        ...
        $ = {
          ...
          async getRecomendedWallets() {
            ...
            if (b.isArray(e)) {
              let t = e.join(","),
                { listings: s } = await U.getAllListings({ recommendedIds: t }),
                r = Object.values(s);
              r.sort((t, s) => e.indexOf(t.id) - e.indexOf(s.id)),
                (x.recomendedWallets = r);
            } else {
              let { chains: e, isAuth: s } = I.state,
                ...
                { listings: l } = R
                  ? await U.getMobileListings(a)
                  : await U.getDesktopListings(a);
              x.recomendedWallets = Object.values(l);
            }
            return x.recomendedWallets;
          },
          async getWallets(e) {
            let t = ((e, t) => {
                for (var s in t || (t = {})) N.call(t, s) && _(e, s, t[s]);
                if (S) for (var s of S(t)) T.call(t, s) && _(e, s, t[s]);
                return e;
              })({}, e),
              {
              ...
              { recomendedWallets: o } = x;
            if ("ALL" === r) return x.wallets;
            o.length
          ...
          getWalletImageUrl: (e) => U.getWalletImageUrl(e),
          getAssetImageUrl: (e) => U.getAssetImageUrl(e),
          resetSearch() {
            ...
            t && (Z.themeMode = t),
              s &&
                (Z.themeVariables = ((e, t) => {
                  for (var s in t || (t = {})) B.call(t, s) && q(e, s, t[s]);
                  if (z) for (var s of z(t)) J.call(t, s) && q(e, s, t[s]);
                  return e;
                })({}, s));
          },
        },
      ...
      class o {
        ...
        async initUi() {
          if ("undefined" != typeof window) {
            await s.e(2626).then(s.bind(s, 42626));
