  ...
  [837],
  {
    20837: (t, e, r) => {
      ...
      var i = r(21374),
        o = r(76590),
        l = r(890);
      class f extends l.Vw {
        constructor(t, e) {
          super(), (this.finished = !1), (this.destroyed = !1), (0, o.sd)(t);
          let r = (0, l.ZJ)(e);
          if (
        ...
        update(t) {
          return (0, o.CC)(this), this.iHash.update(t), this;
        }
        digestInto(t) {
          (0, o.CC)(this),
            (0, o.DO)(t, this.outputLen),
            (this.finished = !0),
      ...
      let p = Array.from({ length: 256 }, (t, e) =>
      ...
      function x(t) {
        return c(t), m(y(Uint8Array.from(t).reverse()));
      }
      function S(t, e) {
      ...
      let H = (t) => (d << BigInt(t - 1)) - u,
        P = (t) => new Uint8Array(t),
        L = (t) => Uint8Array.from(t);
      function Z(t, e, r) {
      ...
      function Y(t, e) {
        if (t === _) throw Error("invert: expected non-zero number");
        if (e <= _) throw Error("invert: expected positive modulus, got " + e);
        let r = M(t, e),
          n = e,
          i = _,
          o = k,
      ...
      function Q(t, e, r = !1, n = {}) {
        let i;
        if (t <= _) throw Error("invalid field: expected ORDER > 0, got " + t);
        ...
        let f = Object.freeze({
          ...
          pow: (t, e) =>
            (function (t, e, r) {
              if (r < _) throw Error("invalid exponent, negatives unsupported");
              if (r === _) return t.ONE;
              if (r === k) return e;
              let n = t.ONE,
                i = e;
              for (; r > _; )
                r & k && (n = t.mul(n, i)), (i = t.sqr(i)), (r >>= k);
              return n;
            })(f, t, e),
          div: (e, r) => M(e * Y(r, t), t),
          sqrN: (t) => t * t,
                  ...
                  return (function (t) {
                    ...
                    for (
                      ...
                      (function (t, e, r) {
                        ...
                        if (r <= _) throw Error("invalid modulus");
                        if (r === k) return _;
                        let n = k;
                        for (; e > _; )
                          e & k && (n = (n * t) % r),
                    ...
                    return function (t, l) {
                      ...
                      for (; !t.eql(u, t.ONE); ) {
                        ...
                        let e = 1;
                        for (let r = t.sqr(u); e < f && !t.eql(r, t.ONE); e++)
                          r = t.sqr(r);
                        let r = t.pow(s, k << BigInt(f - e - 1));
                        (s = t.sqr(r)),
                          (a = t.mul(a, r)),
                          (u = t.mul(u, s)),
                          (f = e);
      ...
      function ti(t, e) {
        return (
          tn(t, e), { windows: Math.ceil(e / t) + 1, windowSize: 2 ** (t - 1) }
        );
      }
      let to = new WeakMap(),
        tl = new WeakMap();
        ...
        tB = Q(tw, void 0, void 0, {
          sqrt: function (t) {
            let e = BigInt(3),
              ...
              b = (W(E, r, tw) * s) % tw,
              v = W(b, tb, tw);
            if (!tB.eql(tB.sqr(v), t)) throw Error("Cannot find square root");
            return v;
          },
        }),
        tx = (function (t, e) {
            ...
            (function (t) {
              ...
              let {
                  ...
                  function s(t) {
                    ...
                    try {
                      e = "bigint" == typeof t ? t : B(I("private key", t, i));
                    } catch (e) {
                      throw Error(
                    ...
                    return o && (e = M(e, l)), N("private key", e, tp, l), e;
                  }
                  function a(t) {
                    if (!(t instanceof c))
                  ...
                  class c {
                    ...
                    wNAF(t) {
                      return w.wNAFCached(this, t, c.normalizeZ);
                    }
                    multiplyUnsafe(t) {
                      let { endo: e, n: i } = r;
                      N("scalar", t, tg, i);
                      ...
                      if (!e || w.hasPrecomputes(this))
                        return w.wNAFCachedUnsafe(this, t, c.normalizeZ);
                      let {
                          k1neg: l,
                          k1: f,
                          k2neg: s,
                    ...
                    multiply(t) {
                      ...
                      if ((N("scalar", t, tp, l), o)) {
                        let {
                          ...
                          { p: a, f: u } = this.wNAF(l),
                          { p: d, f: h } = this.wNAF(s);
                        (a = w.constTimeNegate(r, a)),
                          (d = w.constTimeNegate(f, d)),
              ...
              class p {
                ...
                static fromCompact(t) {
                  let r = e.nByteLength;
                  return new p(
                    c((t = I("compactSignature", t, 2 * r)), 0, r),
                    c(t, r, 2 * r)
                  );
                }
                static fromDER(t) {
                ...
                assertValidity() {
                  N("r", this.r, tp, n), N("s", this.s, tp, n);
                }
                addRecoveryBit(t) {
                ...
                recoverPublicKey(t) {
                  ...
                  let h = (1 & s) == 0 ? "02" : "03",
                    ...
                    p = l(-a * g),
                    y = l(o * g),
                    w = f.BASE.multiplyAndAddUnsafe(c, p, y);
                ...
                normalizeS() {
                  return this.hasHighS()
                    ? new p(this.r, l(-this.s), this.recovery)
                    : this;
                }
                toDERRawBytes() {
              ...
              function q(t) {
                return (
                  N("num < 2^" + e.nBitLength, t, tg, b), S(t, e.nByteLength)
                );
              }
              ...
              return (
                f.BASE._setWindowSize(8),
                {
                  ...
                  sign: function (t, i, o = P) {
                    let { seed: a, k2sig: d } = (function (t, i, o = P) {
                      if (["recovered", "canonical"].some((t) => t in o))
                        throw Error("sign() legacy options not supported");
                      let { hash: a, randomBytes: d } = e,
                        { lowS: h, prehash: c, extraEntropy: g } = o;
                      null == h && (h = !0),
                        (t = I("msgHash", t)),
                        ta(o),
                        c && (t = I("prehashed msgHash", a(t)));
                      let y = E(t),
                        w = s(i),
                        b = [q(w), q(y)];
                      if (null != g && !1 !== g) {
                      ...
                      return {
                        ...
                        k2sig: function (t) {
                          ...
                          let a = l(i * l(y + s * w));
                          if (a === tg) return;
                          let d = (2 * (o.x !== s)) | Number(o.y & tp),
                            c = a;
                          return (
                            h &&
                              a > n >> tp &&
                              ((c = (e = a) > n >> tp ? l(-e) : e), (d ^= 1)),
                            new p(s, c, d)
                          );
                        },
                      };
                    })(t, i, o);
                    return Z(e.hash.outputLen, e.nByteLength, e.hmac)(a, d);
                  },
                  verify: function (t, r, i, o = L) {
                    let s, a;
                    (r = I("msgHash", r)), (i = I("publicKey", i));
                    let { lowS: u, prehash: d, format: c } = o;
                    if ((ta(o), "strict" in o))
                    ...
                    try {
                      if ((y && (a = new p(t.r, t.s)), g)) {
                        try {
                          "compact" !== c && (a = p.fromDER(t));
                        } catch (t) {
                          if (!(t instanceof tc.Err)) throw t;
                        }
                        a || "der" === c || (a = p.fromCompact(t));
                      }
                      s = f.fromHex(i);
                    } catch (t) {
                      return !1;
                    ...
                    let { r: w, s: m } = a,
                      ...
                      B = l(b * v),
                      x = l(w * v),
                      S = f.BASE.multiplyAndAddUnsafe(s, B, x)?.toAffine();
                    return !!S && l(S.x) === w;
                  },
                  ProjectivePoint: f,
                  Signature: p,
