    ...
    37707: (t, e, r) => {
      ...
      function Q(t = h.FIVE_MINUTES, e) {
        let r,
          i,
          n,
          o = (0, h.toMiliseconds)(t || h.FIVE_MINUTES);
        return {
          resolve: (t) => {
      ...
      class tv {
        ...
        _log(t, e) {
          ...
          null == td[r] &&
            ...
            tc > td[r] || console.log.apply(console, e);
        }
        debug(...t) {
        ...
        static setLogLevel(t) {
          ...
          if (null == e)
            return void tv.globalLogger().warn("invalid log level - " + t);
          tc = e;
        }
        static from(t) {
          return new tv(t);
      ...
      function tM(t, e) {
        if ((e || (e = {}), "number" == typeof t)) {
          tA.checkSafeUint53(t, "invalid arrayify value");
          let e = [];
        ...
        if (
          ...
          r.length % 2 &&
            ("left" === e.hexPad
              ...
              : "right" === e.hexPad
              ? (r += "0")
              : tA.throwArgumentError("hex data is odd-length", "value", t));
          let i = [];
        ...
        return tx(t)
          ? ty(new Uint8Array(t))
          : tA.throwArgumentError("invalid arrayify value", "value", t);
      }
      function tE(t, e) {
        return !(
          "string" != typeof t ||
      ...
      function tI(t, e) {
        if ((e || (e = {}), "number" == typeof t)) {
          tA.checkSafeUint53(t, "invalid hexlify value");
          let e = "";
        ...
        return tA.throwArgumentError("invalid hexlify value", "value", t);
      }
      function tN(t, e, r) {
        return (
          "string" != typeof t
            ? (t = tI(t))
            : (!tE(t) || t.length % 2) &&
              tA.throwArgumentError("invalid hexData", "value", t),
          (e = 2 + 2 * e),
      ...
      function tB(t, e) {
        for (
          "string" != typeof t
            ? (t = tI(t))
            : tE(t) || tA.throwArgumentError("invalid hex string", "value", t),
            t.length > 2 * e + 2 &&
        ...
        if ((tE(t) && !(t.length % 2)) || tx(t)) {
          ...
          64 === r.length
            ...
            ? ((e.r = tI(r.slice(0, 32))),
              (e.s = tI(r.slice(32, 64))),
              (e.v = r[64]))
            : tA.throwArgumentError("invalid signature string", "signature", t),
            e.v < 27 &&
              (0 === e.v || 1 === e.v
                ? (e.v += 27)
                : tA.throwArgumentError(
          ...
          let r = tM(e.s);
          r[0] >= 128 &&
            tA.throwArgumentError("signature s out of range", "signature", t),
            e.recoveryParam && (r[0] |= 128);
          let i = tI(r);
          e._vs &&
            (tE(e._vs) ||
              tA.throwArgumentError("signature invalid _vs", "signature", t),
            (e._vs = tB(e._vs, 32))),
            null == e._vs
              ? (e._vs = i)
              : e._vs !== i &&
      ...
      !(function (t, e) {
        ...
        var m = function (t, e, r) {
          ...
          (h = (((o + (n >>> 13)) | 0) + (tb >>> 26)) | 0),
            ...
            (o = (o + Math.imul(w, Q)) | 0),
            (i = (i + Math.imul(v, J)) | 0),
            (n = ((n = (n + Math.imul(v, Y)) | 0) + Math.imul(A, J)) | 0),
            (o = (o + Math.imul(A, Y)) | 0),
            (i = (i + Math.imul(p, W)) | 0),
      ...
      ee(ei),
        ...
        (function (t) {
          ...
          for (;;) {
            ...
            e.push(
              ((r = n),
              er(1 + (i = t)(), 1 + r, i).map((t) => [t[0], t.slice(1)]))
            );
          }
          !(function (t) {
            let e = {};
...
`;
      ...
      "function" == typeof Object.create
        ...
        (ep.toHex32 = function (t, e) {
          for (var r = "", i = 0; i < t.length; i++) {
            var n = t[i];
            "little" === e && (n = ev(n)), (r += eb(n.toString(16)));
          }
          return r;
        }),
        (ep.zero2 = eA),
      ...
      ep.inherits(eK, ej),
        ...
        (eK.prototype._update = function (t, e) {
          for (var r = this.W, i = 0; i < 16; i++) r[i] = t[e + i];
          for (; i < r.length; i++)
            r[i] = eP(ez(r[i - 2]), r[i - 7], eL(r[i - 15]), r[i - 16]);
          var n = this.h[0],
            o = this.h[1],
            f = this.h[2],
            s = this.h[3],
          ...
          for (em(this.k.length === r.length), i = 0; i < r.length; i++) {
            var d = eU(l, eq(u), eT(u, h, a), this.k[i], r[i]),
              c = ek(eF(n), eD(n, o, f));
            (l = a),
              (a = h),
              (h = u),
          ...
          (this.h[0] = ek(this.h[0], n)),
            (this.h[1] = ek(this.h[1], o)),
            (this.h[2] = ek(this.h[2], f)),
            (this.h[3] = ek(this.h[3], s)),
            (this.h[4] = ek(this.h[4], u)),
            (this.h[5] = ek(this.h[5], h)),
            (this.h[6] = ek(this.h[6], a)),
            (this.h[7] = ek(this.h[7], l));
        }),
      ...
      ep.inherits(e8, e3),
        ...
        (e8.prototype._prepareBlock = function (t, e) {
          ...
          for (; i < r.length; i += 2) {
            var n = (function (t, e) {
                var r = eG(t, e, 19) ^ eG(e, t, 29) ^ eY(t, e, 6);
              ...
              s = r[i - 13],
              u = (function (t, e) {
                var r = eG(t, e, 1) ^ eG(t, e, 8) ^ eY(t, e, 7);
                return r < 0 && (r += 0x100000000), r;
              })(r[i - 30], r[i - 29]),
              h = (function (t, e) {
        ...
        (rA.prototype._wnafMulAdd = function (t, e, r, i, n) {
          ...
          for (o = i - 1; o >= 1; o -= 2) {
            var c = o - 1,
              p = o;
            if (1 !== u[c] || 1 !== u[p]) {
              (a[c] = rm(r[c], u[c], this._bitLength)),
      ...
      var rS = ra(function (t, e) {
          (e.base = rA), (e.short = rx), (e.mont = null), (e.edwards = null);
        }),
        rI = ra(function (t, e) {
          var r,
            i = rp.assert;
      ...
      function rN(t) {
        ...
        (this.hash = t.hash),
          ...
          (this.K = null),
          (this.V = null);
        var e = rc.toArray(t.entropy, t.entropyEnc || "hex"),
          r = rc.toArray(t.nonce, t.nonceEnc || "hex"),
          i = rc.toArray(t.pers, t.persEnc || "hex");
        rl(
      ...
      (rN.prototype._init = function (t, e, r) {
        ...
        (rN.prototype.generate = function (t, e, r, i) {
          ...
          "string" != typeof e && ((i = r), (r = e), (e = null)),
            r && ((r = rc.toArray(r, i || "hex")), this._update(r));
          for (var n = []; n.length < t; )
            (this.V = this._hmac().update(this.V).digest()),
              (n = n.concat(this.V));
          var o = n.slice(0, t);
          return this._update(r), this._reseed++, rc.encode(o, e);
        });
      var rB = rp.assert;
      function rC(t, e) {
        (this.ec = t),
              ...
              if (!l.isInfinity()) {
                ...
                if (0 !== c.cmpn(0)) {
                  ...
                  if (0 !== (p = p.umod(this.n)).cmpn(0)) {
                    var m = !!l.getY().isOdd() | (2 * (0 !== d.cmp(c)));
                    return (
                      i.canonical &&
                        p.cmp(this.nh) > 0 &&
                        ((p = this.n.sub(p)), (m ^= 1)),
                      new rO({ r: c, s: p, recoveryParam: m })
                    );
                  }
                }
              }
      ...
      let rL = new tv("signing-key/5.7.0"),
        rz = null;
      function rj() {
        return rz || (rz = new rq("secp256k1")), rz;
      }
      class rH {
        constructor(t) {
        ...
        signDigest(t) {
          let e = rj().keyFromPrivate(tM(this.privateKey)),
            r = tM(t);
          32 !== r.length &&
            rL.throwArgumentError("bad digest length", "digest", t);
          ...
          case "eip191":
            ...
            return (
              ...
              (function (t, e) {
                ...
                if (
                  ("string" != typeof r &&
                    ef.throwArgumentError("invalid address", "address", r),
                  ...
                  for (
                    r.substring(2, 4) !==
                      ...
                      ef.throwArgumentError("bad icap checksum", "address", r),
                      i = new tU(r.substring(4), 36).toString(16);
                    i.length < 40;

                  )
                    i = "0" + i;
                  i = es("0x" + i);
                } else ef.throwArgumentError("invalid address", "address", r);
                return i;
              })(eo(s), u).toLowerCase() === f.toLowerCase()
            );
          case "eip1271":
            return await rG(t, e, r.s, i, n, o);
          default:
            throw Error(
      ...
      async function r6(t) {
        let { cacao: e, projectId: r } = t,
          ...
          o = r8(n, n.iss),
          f = r3(n.iss);
        return await rQ(f, o, i, r1(n.iss), r);
      }
      let r8 = (t, e) => {
...
- ${t}`
        ...
        return (
          ...
          [r, i, "", n, "", o, f, s, u, h, a, l, d, c].filter((t) => null != t)
            .join(`
`)
        );
      };
                ...
                Object.keys((null == (n = t.att) ? void 0 : n[r]) || {})
                  ...
                  .forEach((n) => {
                    ...
                    i.att[r] = rY(
                      ((t, e) => {
                        for (var r in e || (e = {}))
                          rX.call(e, r) && r$(t, r, e[r]);
                        if (rW)
                          for (var r of rW(e)) rZ.call(e, r) && r$(t, r, e[r]);
                        return t;
                      })({}, i.att[r]),
                      rV({
                        [n]:
      ...
      function ic() {
        let t = v.TZ();
        return {
          privateKey: (0, A.dI)(t.secretKey, is),
          publicKey: (0, A.dI)(t.publicKey, is),
        };
      }
      function ip() {
      ...
      function im(t, e) {
        let r = v.Tc((0, A.sH)(t, is), (0, A.sH)(e, is), !0),
          i = new p.i(g.aD, r).expand(32);
        return (0, A.dI)(i, is);
      }
      function ig(t) {
        let e = (0, g.tW)((0, A.sH)(t, is));
        return (0, A.dI)(e, is);
      }
      function iv(t) {
        let e = (0, g.tW)((0, A.sH)(t, ia));
        return (0, A.dI)(e, is);
      }
      function iA(t) {
        return (0, A.sH)(`${t}`, io);
      ...
      function ib(t) {
        return Number((0, A.dI)(t, io));
      }
      function iy(t) {
        let e = iA("u" > typeof t.type ? t.type : 0);
        if (ib(e) === il && typeof t.senderPublicKey > "u")
          throw Error("Missing sender public key for type 1 envelope");
        let r =
            "u" > typeof t.senderPublicKey
              ? (0, A.sH)(t.senderPublicKey, is)
              : void 0,
          i = "u" > typeof t.iv ? (0, A.sH)(t.iv, is) : (0, m.randomBytes)(12);
        return iE({
          type: e,
          sealed: new c.g6((0, A.sH)(t.symKey, is)).seal(
            i,
            (0, A.sH)(t.message, ia)
          ),
          iv: i,
      ...
      function iw(t, e) {
        ...
        return iE({ type: r, sealed: (0, A.sH)(t, ia), iv: i, encoding: e });
      }
      function ix(t) {
        let e = new c.g6((0, A.sH)(t.symKey, is)),
          { sealed: r, iv: i } = iS({
            encoded: t.encoded,
            encoding: t?.encoding,
          }),
      ...
      function iM(t, e) {
        let { sealed: r } = iS({ encoded: t, encoding: e });
        return (0, A.dI)(r, ia);
      }
      function iE(t) {
        let { encoding: e = iu } = t;
        if (ib(t.type) === id)
          return (0, A.dI)((0, A.xW)([t.type, t.sealed]), e);
        if (ib(t.type) === il) {
        ...
        return (0, A.dI)((0, A.xW)([t.type, t.iv, t.sealed]), e);
      }
      function iS(t) {
        let { encoded: e, encoding: r = iu } = t,
          i = (0, A.sH)(e, r),
          n = i.slice(0, 1);
        if (ib(n) === il) {
          let t = i.slice(1, 33),
      ...
      function iI(t, e) {
        let r = iS({ encoded: t, encoding: e?.encoding });
        return iN({
          type: ib(r.type),
          senderPublicKey:
            "u" > typeof r.senderPublicKey
              ? (0, A.dI)(r.senderPublicKey, is)
              : void 0,
      ...
      var ik = Object.defineProperty,
        ...
        iq = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        iL = (t, e) => {
          for (var r in e || (e = {})) iD.call(e, r) && iq(t, r, e[r]);
          if (iT) for (var r of iT(e)) iF.call(e, r) && iq(t, r, e[r]);
          return t;
        };
      function iz(t) {
        var e;
          ...
          d.stringify(
            iL(
              iP(
                ...
                iU({ expiryTimestamp: t.expiryTimestamp })
              ),
      ...
      function iW(t, e) {
        let { message: r, code: i } = iV[t];
        return { message: e ? `${r} ${e}` : r, code: i };
      }
      function iX(t, e) {
        let { message: r, code: i } = iY[t];
        return { message: e ? `${r} ${e}` : r, code: i };
      }
      function iZ(t, e) {
        return (
      ...
      function i7(t) {
        let e = !0;
        return (
          iZ(t) ? t.length && (e = t.every((t) => i1(t, !1))) : (e = !1), e
        );
      }
      function nt(t, e) {
        let r = null;
          ...
          case k.reactNative:
            (i = t),
              U() &&
                ...
                null != r.g &&
                r.g.NetInfo &&
                r.g?.NetInfo.addEventListener((t) => i(t?.isConnected));
          case k.node:
        }
      }
      let ny = {};
